...
public class NaiveBayes {
	...
	public NaiveBayes(final String mode) {
		if(mode.equalsIgnoreCase(TestConfigsML.graph_features)) {
			trainedModel = TestConfigsML.prefix_models+"ml_nb_att_selected.model";
		}else if(mode.equalsIgnoreCase(TestConfigsML.topk_features)) {
			trainedModel = TestConfigsML.prefix_models+"tk_nb_att_selected.model";
		}
	}
	...
	public static void main(final String[] args) {
		...
		String model_path = "";
		final NaiveBayes reg = new NaiveBayes(model_path);
