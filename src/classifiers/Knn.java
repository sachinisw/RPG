...
public class Knn {
	...
	public Knn(final String mode) {
		if(mode.equalsIgnoreCase(TestConfigsML.graph_features)) {
			trainedModel = TestConfigsML.prefix_models+"ml_knn_att_selected.model";
		}else if(mode.equalsIgnoreCase(TestConfigsML.topk_features)) {
			trainedModel = TestConfigsML.prefix_models+"tk_knn_att_selected.model";
		}
	}
	...
	public static void main(final String[] args) {
		...
		String model_path = "";
		final Knn reg = new Knn(model_path);
