...
public class Regression {
	...
	public Regression(final String mode) {
		if(mode.equalsIgnoreCase(TestConfigsML.graph_features)) {
			trainedModel = TestConfigsML.prefix_models+"ml_log_att_selected.model";
		}else if(mode.equalsIgnoreCase(TestConfigsML.topk_features)) {
			trainedModel = TestConfigsML.prefix_models+"tk_log_att_selected.model";
		}
	}
	...
	public static void main(final String[] args) {
		...
		String model_path = "";
		final Regression reg = new Regression(model_path);
